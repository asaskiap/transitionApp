    ...
    return (
      <ScrollableScreenContainer>
        ...
        <Paragraph>
          ...
          Bedürfnisse beginnen stets mehr in unterschiedliche Richtungen zu
          gehen und man beginnt zu zweifeln ob das Leben auf der Bühne einen
          dauerhaft glücklich machen wird. Meist kommt hiermit der erste Stein
          der Veränderung ins Rollen und man beginnt sich über alternative
        ...
        <Paragraph>
          ...
          von anderen. Wenn man eine Tätigkeit gefunden hat, in der es möglich
          ist die eigenen Werte aktiv zu leben und zu praktizieren, korreliert
          dies sehr stark mit Lebensglück und Erfüllung. Eine Möglichkeit um
          Zugang zu den eigenen Werten zu bekommen, ist die Analyse von dem Wert
          der Tanz für einen hat. Ist es die künstlerische Tätigkeit? Ist es das
          Arbeiten am Theater? Ist es die Ästhetik? Ist es andere Menschen
          glücklich zu machen? Ist es die Arbeit mit dem eigenen Körper? Ist es
          die Arbeit im Team? Ist es das Auftreten und die Aufmerksamkeit die
          man bekommt? Etc. Eine genaue Auseinandersetzung mit den eigenen
          Werten, eröffnet einem meist schnell neue Perspektiven auf andere
          Tätigkeitsfelder in denen diese Werte auf andere, aber ähnlich
          erfüllende Weise gelebt werden können.
        </Paragraph>
      </ScrollableScreenContainer>
    );
  }
